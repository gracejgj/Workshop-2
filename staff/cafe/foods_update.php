...
<div id="wrapper">
  <div id="header">
		<div id="img">
		  <a href="foods.php"><img src="img/logos.png" alt="Tapau's"></a>
		</div>
		<div class="logout">
   ...
   <div id="navigation">
	...
	<div id="content">
	<br><br>
	<h3 style="text-align:center">UPDATE MENU FOOD</h3>
	<form action="foods_update2.php?pid=<?php echo $p_id; ?>" method="post"  method="post" enctype="multipart/form-data">
